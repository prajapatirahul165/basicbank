...
<br>
<center><button  type="submit" name="submit" class="btn btn-outline-success" >Transfer Amount</button></center>
    ...
    <div class="footer">
        This project is made by <span style="font-weight: 500;margin-left:0px;font-size:20px;color:red;"> VAIBHAV SHARMA</span>#2022.
        <br>
        <br>
